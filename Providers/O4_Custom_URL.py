...
def get_DOP40_cookie():
    ...
    if (not DOP40_cookie) or (time.time()-DOP40_time)>=3600:
        ...
        DOP40_cookie=requests.Session().get('https://sg.geodatenzentrum.de/web_bkg_webmap/lib/bkgwebmap-0.12.5.all.min.js?bkg_appid=4cc455dc-a595-bbcf-0d00-c1d81caab5c3').headers['Set-Cookie'].split(';')[0]
        DOP40_time=time.time()
    return DOP40_cookie
