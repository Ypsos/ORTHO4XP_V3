...
T = {
    ...
    # Regroupement par dérive + statuts (colonne gauche)
    "Dérive"                            : "Dérive",
    "Dérive faible"                     : "Dérive faible",
    ...
    "Auto depuis cible : corr R{r:+d} G{g:+d} B{b:+d} | Cont {cr:+d}/{cg:+d}/{cb:+d} | Sat {sr:+d}/{sg:+d}/{sb:+d}"
                                        : "Auto depuis cible : corr R{r:+d} G{g:+d} B{b:+d} | Cont {cr:+d}/{cg:+d}/{cb:+d} | Sat {sr:+d}/{sg:+d}/{sb:+d}",
    "🎨 Correction en série"            : "🎨 Correction en série",
    ...
    # ── MODULE .comb + MENU AVANCÉ (ajouts du projet) ──────────────
    "Ortho4XP — Avancé"                     : "Ortho4XP — Avancé",
    "Outils avancés"                        : "Outils avancés",
    "Chaque outil s'ouvre dans sa propre fenêtre." : "Chaque outil s'ouvre dans sa propre fenêtre.",
    "Générer un fichier .comb"              : "Générer un fichier .comb",
    "JOSM / Extents (masques, zones)"       : "JOSM / Extents (masques, zones)",
    "Altimétrie"                            : "Altimétrie",
    "Correction imagerie"                   : "Correction imagerie",
    "Fermer"                                : "Fermer",
    "Générer un .comb global (style EUR.comb)" : "Générer un .comb global (style EUR.comb)",
    "Coche les providers, choisis zone + priorité, puis Générer." : "Coche les providers, choisis zone + priorité, puis Générer.",
    "Provider"                              : "Provider",
    "Score"                                 : "Score",
    "Zone / extent"                         : "Zone / extent",
    "Priorité"                              : "Priorité",
    "Automatique"                           : "Automatique",
    "Importer un .comb"                     : "Importer un .comb",
    "Créer un provider (.lay)"              : "Créer un provider (.lay)",
    "Aperçu"                                : "Aperçu",
    "Générer"                               : "Générer",
    ...
    "lay_win_title"      : "Générateur de provider (.lay)",
    "lay_active_tile"    : "Tuile active :",
    "lay_provider_name"  : "Nom du provider",
    "lay_request_type"   : "Type de requête",
    "lay_url_prefix"     : "url_prefix (WMS)",
    "lay_url_template"   : "url_template (TMS)",
    "lay_layers"         : "layers (WMS)",
    "lay_in_gui"         : "Afficher dans le menu (in_GUI)",
    "lay_preview_label"  : "Aperçu du fichier .lay qui sera généré",
    "lay_btn_pcrs"       : "🛰 Preset PCRS_IGN",
    "lay_btn_ign"        : "🇫🇷 Preset IGN Ortho",
    "lay_btn_load"       : "📂 Charger un .lay",
    "lay_btn_clear"      : "🧹 Effacer",
    "lay_btn_create"     : "💾 Créer le .lay",
    "lay_msg_name_req"   : "Le nom du provider est obligatoire.",
    "lay_msg_created"    : "Fichier créé :",
    "lay_msg_restart"    : "Fermez puis relancez Ortho4XP pour que la nouvelle imagerie apparaisse dans le menu Imagery.",
    # ── RELIEF SONNY (module altimétrie auto) ──────────────────────
    "Aucun .hgt en place après décompression."          : "Aucun .hgt en place après décompression.",
    "Aucun .hgt valide dans ce ZIP."                    : "Aucun .hgt valide dans ce ZIP.",
    "Aucun emplacement de relief valide.\n\n"           : "Aucun emplacement de relief valide.\n\n",
    "Ce disque ne dispose que de %.1f Go "              : "Ce disque ne dispose que de %.1f Go ",
    "cfg application non mis à jour : "                 : "cfg application non mis à jour : ",
    "Choisissez le disque ou le dossier où créer votre " : "Choisissez le disque ou le dossier où créer votre ",
    "custom_dem renseigné aussi dans le cfg application." : "custom_dem renseigné aussi dans le cfg application.",
    "Décompression dans %s…"                            : "Décompression dans %s…",
    "Dépôt Sonny indisponible (%s)."                    : "Dépôt Sonny indisponible (%s).",
    "Disque où STOCKER le relief (rien à chercher "     : "Disque où STOCKER le relief (rien à chercher ",
    "Emplacement relief déjà défini : %s"               : "Emplacement relief déjà défini : %s",
    "Espace disque limité"                              : "Espace disque limité",
    "Étape 1 sur 2 — Emplacement de stockage"           : "Étape 1 sur 2 — Emplacement de stockage",
    "Étape 2 sur 2 — Téléchargement"                    : "Étape 2 sur 2 — Téléchargement",
    "Hors zone Sonny : relief standard."                : "Hors zone Sonny : relief standard.",
    "Import annulé : aucun ZIP trouvé."                 : "Import annulé : aucun ZIP trouvé.",
    "Import du relief"                                  : "Import du relief",
    "Import Sonny : modules absents (%s)."              : "Import Sonny : modules absents (%s).",
    "Import Sonny : tuile courante illisible."          : "Import Sonny : tuile courante illisible.",
    "Installer le ZIP téléchargé"                       : "Installer le ZIP téléchargé",
    "L'emplacement du relief défini précédemment est "  : "L'emplacement du relief défini précédemment est ",
    "Le site Sonny va s'ouvrir.\n\n"                    : "Le site Sonny va s'ouvrir.\n\n",
    "Relief haute définition"                           : "Relief haute définition",
    "Relief HD intégré."                                : "Relief HD intégré.",
    "Relief installé"                                   : "Relief installé",
    "Relief rangé dans :\n%s\n\n"                       : "Relief rangé dans :\n%s\n\n",
    "Relief Sonny : modules absents (%s)."              : "Relief Sonny : modules absents (%s).",
    "Relief Sonny : tuile courante illisible."          : "Relief Sonny : tuile courante illisible.",
    "Relief Sonny automatique"                          : "Relief Sonny automatique",
    "Relief Sonny déjà installé pour cette tuile : %s"  : "Relief Sonny déjà installé pour cette tuile : %s",
    "Relief Sonny indisponible : relief standard."      : "Relief Sonny indisponible : relief standard.",
    "Relief Sonny intégré : %d dalle(s)."               : "Relief Sonny intégré : %d dalle(s).",
    "Relief Sonny prêt."                                : "Relief Sonny prêt.",
    "Relief standard conservé."                         : "Relief standard conservé.",
    "Sélectionnez le fichier ZIP Sonny (%s.zip)"        : "Sélectionnez le fichier ZIP Sonny (%s.zip)",
    "Si vos altimétries sont sur un disque externe,"    : "Si vos altimétries sont sur un disque externe,",
    "Téléchargez %s puis « Importer le relief téléchargé »." : "Téléchargez %s puis « Installer le ZIP téléchargé ».",
    "Un relief haute définition (Sonny) est disponible pour " : "Un relief haute définition (Sonny) est disponible pour ",
}
